...
export default function HeroSection() {
  ...
  useEffect(() => {
    const cycle = () => {
      ...
      setTimeout(() => {
        // 2. snap next word in from below (no transition)
        setIndex((prev) => (prev + 1) % cyclingWords.length);
        setAnimState("enter");
      }, 380);

      // 3. tiny delay then animate into place
      setTimeout(() => {
    ...
    <>
      <style>{`
        ...
        .cycling-wrapper {
          ...
          /* wide enough for "Front Desk" — the longest phrase */
          min-width: 10ch;
          white-space: nowrap;
        }
        ...
        /* enter: snap below with NO transition, then JS adds visible */
        .cycling-word.enter {
          opacity: 0;
          transform: translateY(60%);
          filter: blur(10px);
        ...
        <div className="hero-inner">
          ...
          <div className="hero-content">
            ...
            <h1 className="hero-heading">
              Your Clinic&apos;s
              <br />
              {/* "AI" stays fixed; only the role word cycles */}
              AI{" "}
